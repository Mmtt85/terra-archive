...
# 표시 이름은 영문 코드네임이라 한국어로는 검색이 안 된다 — 통용될 법한 한글 표기를 검색어로
# 붙인다(화면에 뜨지 않는 검색 키라 여러 개 넣어도 손해가 없다). 정식 출시되면 KR 테이블의
# 공식 이름이 우선하므로 이 목록은 자연히 무의미해진다.
FUTURE_ALIASES = {
    "char_4228_closur": ["클로저"],
    "char_1050_chen3": ["첸"],
    "char_1052_kalts2": ["켈시", "켈시 얼터"],
    "char_1051_headb2": ["지마", "지마 얼터"],
    "char_1048_orchd2": ["타마미츠네 오키드", "오키드", "몬헌"],
    "char_1049_catap2": ["캐터펄트", "몬헌"],
    "char_2027_wang": ["왕"],
    "char_4230_mcnist": ["메커니스트", "기계사"],
    "char_1015_aglna2": ["안젤리나", "안젤리나 얼터", "얼젤리나"],
    "char_4235_thumpy": ["썸피", "산비"],
    "char_4236_tmslot": ["타임슬롯"],
    "char_4237_jcinta": ["자신타", "하신타"],
    "char_4227_gallus": ["갈루스"],
    "char_4215_buddy": ["로도스 아일랜드 정찰대", "정찰대", "버디"],
    "char_4225_tanya": ["크랙본"],
    "char_4234_pedro": ["페드로"],
    "char_4031_liesel": ["리프레사"],
    "char_4223_botany": ["보타니"],
    "char_4224_turdus": ["우쿠식"],
    "char_4229_aphris": ["아프리사"],
    "char_4037_demetr": ["벨로네"],
    "char_4226_veen": ["비이", "빈"],
}
