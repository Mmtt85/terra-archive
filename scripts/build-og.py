...
TAB_META = {
    ...
    "item":    ("ITEM HANDBOOK",         "cards"),
    "event":   ("EVENT HANDBOOK",        "story"),
    "sim":     ("STAGE SIMULATOR",       "nodes"),
...
SUBLINE = {
    ...
    "item":    {"ko": "재료·이벤트 재화 1,400여 종의 설명·용도·획득처.",
                "en": "Descriptions, uses and sources for 1,400+ items.",
                "ja": "素材・イベント交換素材1,400種以上の説明・用途・入手先。"},
    "event":   {"ko": "이벤트 150여 개의 작전·적·재화·보상 오퍼를 한자리에.",
                "en": "Operations, enemies, currencies and rewards for 150+ events.",
                "ja": "150以上のイベントの作戦・敵・素材・報酬を一箇所に。"},
    "sim":     {"ko": "적이 언제 어디서 나와 어디로 가는지, 작전 흐름을 재생.",
                "en": "Replay when, where and how every enemy moves.",
                "ja": "敵がいつどこから現れどこへ向かうか、作戦の流れを再生。"},
