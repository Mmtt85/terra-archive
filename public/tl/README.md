...
- **이벤트·메인 스토리 본문** — 아직 없습니다. 중국어 원문과 한국어 본문은 줄 단위로
  짝이 맞지만(실측으로 확인했습니다), 짝이 맞는 것은 **한섭에 이미 나온 스토리**라
  게임에서 한국어로 읽으실 수 있고, 정작 한섭에 없는 스토리는 짝지을 한국어가 아직
  없습니다. 분량도 사전 전체의 수십 배라 담더라도 별도 파일이어야 합니다.
