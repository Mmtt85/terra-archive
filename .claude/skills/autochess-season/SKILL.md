...
| 중섭 | 미래시 전용이지만 `activity_table` 을 **받는다** — 2026-09-17부터 17표 세트에 들어왔다 | 중섭 새 시즌은 `.gamedata/cn_activity_table.json` 에서 바로 본다 (일회성 `--tables` 수신은 이제 불필요). 스키마가 어긋나 그 표를 건너뛰면 그때만 레포판으로 메운다 (2026-09-05 실측) |
