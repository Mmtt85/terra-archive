...
- **한국서버 점검일에는 스킬을 쓴다** — 큰 점검(오전 10시~오후 4시, 몇 달치가 한 번에 들어옴)은
  `kr-big-patch`, 작은 점검(오후 4시~4시 10분, 들어와 있던 걸 해금만)은 `kr-small-patch`.
  클뜯 반영이 점검 종료보다 2시간 넘게 늦고, CI가 축약해 도는 무거운 단계(적 초상·도면·스킨·
