...
const META: Record<SeoLocale, {
  ...
  ko: {
    ...
    description: "명일방주(아크나이츠) 한국 서버 팬사이트 — 오퍼레이터 백과사전, 기반시설(인프라) 자동 편성 플래너, 공개모집(공채) 태그 계산기.",
    keywords: ["명일방주", "아크나이츠", "Arknights", "오퍼레이터", "오퍼레이터 도감", "인프라", "기반시설", "기반시설 편성", "공개모집", "공채 계산기", "공개모집 태그", "테라 아카이브"],
  },
  en: {
    path: "/en",
    ogLocale: "en_US",
    ...
    description: "Arknights KR-server fansite — full operator encyclopedia, RIIC base auto-assignment planner, and recruitment tag calculator, available in English.",
    keywords: ["Arknights", "operators", "operator database", "RIIC", "base planner", "base layout", "recruitment calculator", "recruitment tags", "Terra Archive"],
  },
  ja: {
    path: "/ja",
    ogLocale: "ja_JP",
    ...
    description: "アークナイツ（韓国サーバー基準）ファンサイト — オペレーター図鑑、基地（インフラ）自動編成プランナー、公開求人タグ計算機を日本語で提供。",
    keywords: ["アークナイツ", "Arknights", "オペレーター", "オペレーター図鑑", "基地", "基地編成", "公開求人", "公開求人 計算機", "求人タグ", "テラアーカイブ"],
  },
};
