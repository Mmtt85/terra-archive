...
/** 생존연산 사막 이야기 도면(ui/sandboxv2/mappreview)은 격자를 바로 위에서 그린 **평면도**인데, 보이는 창이 그림
 *  전체가 아니라 **가운데 5/6** 만 차지한다 (가장자리마다 1/12 여백 — 그래서 그림 비율 = 창 비율이다).
 *  창은 대개 격자 전체, 안개가 걸린 20곳은 안개 방 밖의 처음 보이는 영역이다 (StageRoutes.vb, 2026-09-23).
