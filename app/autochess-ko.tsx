...
//   파일명이 autochess-s<N>.json 으로 바뀐다). 절차는 autochess-season 스킬.
import AutochessSeasons from "./autochess-seasons";
import { type AutochessDoc } from "./autochess";
import s2 from "./data/autochess.json";
import s1 from "./data/autochess-s1.json";
...
export default function AutochessKo({ season, onShowOperator }: {
