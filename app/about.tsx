    ...
    features: [
      {
        ...
        highlight:
          "**모든 걸 100% 대신 짜주는 도구가 아닙니다.** 시너지 세트·시설 간 포인트 시스템·교대 정책까지 반영해 **큰 틀의 90% 이상을 자동으로 잡아주고**, 개인 취향과 특수 상황에 맞춘 **나머지 10%는 박사가 직접 손봐 완성**하도록 설계했습니다. 방별 수동 편집, 빈칸만 채우기, 오퍼별 정예화 조정, 우선 생산 모드 전환을 모두 지원합니다.",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "바쁜 박사를 위한 AI 요약 — 스크립트 전문을 정독하고 10분 분량으로 줄거리 정리",
      ...
      },
      {
        ...
        bullets: [
          "팬텀 & 크림슨 솔리테어부터 쉐이의 기이한 계원까지 정식 5개 테마 전부 + 중국 선행 테마(침몰자의 블랙플로우)는 미래시 토글로 미리 보기",
