...
const CONTENT: Record<Locale, Content> = {
  ...
  en: {
    ...
    features: [
      ...
      {
        tab: "story", icon: "✦", name: "AI Story Digest",
        summary: "Summarizes event side stories into a ~10-minute read, illustrated with cutscenes.",
        bullets: [
          "AI digests written from the full story script — the plot, condensed, for busy Doctors",
  ...
  ja: {
    ...
    features: [
      ...
      {
        tab: "story", icon: "✦", name: "AIストーリー要約",
        summary: "イベントのサイドストーリーを、カットシーンと共に約10分で読めるように要約します。",
        bullets: [
