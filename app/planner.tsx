...
// 에뮬레이터 화면 연동(화면 캡처) + 오퍼 인식 스캐너 (2026-07-22)
...
export default function InfraPlanner({ onShowOperator, extra, includeFuture }: { onShowOperator?: (id: string) => void; extra?: ExtraI18n | null; includeFuture?: boolean } = {}) {
  ...
  // 에뮬레이터 화면 연동 + 오퍼 인식 스캐너 — 별도 컴포넌트(EmulatorCapture)가 스트림·인식을 관리
  ...
  // 에뮬레이터 화면 연동 + 오퍼 인식은 EmulatorCapture 컴포넌트가 담당 (스트림·정지·인식 자체 관리)
