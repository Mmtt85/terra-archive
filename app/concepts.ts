...
const ALIASES: Record<string, string[]> = {
  ...
  "기절": ["스턴", "스탠", "stun"],
  "수면": ["슬립", "재움", "sleep"],
  // '침묵'·'silence'는 여기서 뺐다 (2026-08-08) — 침묵 컨셉이 없던 시절 가장 가까운
  // 태그로 보내려고 달아 둔 별칭인데, 이제 진짜 침묵 태그가 생겨 두 개가 같이 잡혔다.
  // 공격 중지 = 적이 공격을 멈춤 / 침묵 = 적의 특수 능력 무효화 — 다른 효과다.
  "공격 중지": ["무장해제", "공격봉인"],
  ...
  "포트리스": ["요새", "fortress"],
  "공포": ["도주", "fear"],
  // 게임 문구는 "특수 능력 무효화" — 사람들은 '침묵'으로 부르므로 그 표기를 태그명으로 쓰고,
  // 게임 문구 쪽으로 찾는 사람을 위해 별칭에 넣어 둔다 (사용자 요청 2026-08-08)
  "침묵": ["사일런스", "실렌스", "스킬봉인", "능력봉인", "특수능력무효화", "특수능력무효", "silence"],
