...
const TICK_MS = 200;       // 판정 주기 (숨겨진 탭에서는 크롬이 1초로 늘린다 — 그래도 충분)
...
const SETTLE_MS = 300;     // 마지막 움직임 이후 이만큼 잠잠하면 안착 (4~5초 체감 단축, 2026-07-26)
...
const OCR_MAX_W = 900;     // 1024→900 (2026-07-26 "성능 희생해도 속도"): 캔버스 1800px, 23% 추가 감소
