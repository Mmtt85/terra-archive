    ...
    <ModalWindow className="operator-modal lens-modal" onClose={onClose} label={`◉ ${t("PRTS 시뮬레이션")}`}
      ...
      <div className="lens-body lens-help">
        ...
        <ul>
          ...
          <li>{rich(t("**전략** — '선택한 전략' 확정 화면에서 내가 고른 전략을 읽어 표시줄에 띄웁니다. 연합에서는 다른 참가자의 전략도 참가자 카드의 그림으로 알아봅니다 — 최대 네 명까지 보여 주고, 아직 못 읽은 자리는 '읽는 중'으로 둡니다 (다른 참가자 인식은 아직 실플레이 확인 전)."))}</li>
