...
// 로케일별 이벤트 도감 래퍼 — 자기 언어 데이터만 정적 임포트한다 (app/enemies-ja.tsx와 같은 관례).
// 한 모듈에서 세 로케일을 동적 선택하면 셋 다 같은 청크에 묶인다.
import EventDex, { type EventDoc } from "./events";
import doc from "./data/events.ja.json";

export default function EventDexJA({ onShowOperator, onOpenGuide, modalOnly, initialId, onCloseModal }: {
