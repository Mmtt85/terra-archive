...
import { ops, withElite, optimize, setLayoutPreset, type Elite, type ProdPriority, type LayoutPreset } from "./planner-engine";
...
self.addEventListener("message", (event) => {
  void (async () => {
    ...
    try {
      // 기지 배치 프리셋 동기화 — 메인 스레드의 setLayoutPreset은 이 워커 인스턴스에 안 미친다
