...
import doc from "./data/autochess.ja.json";

const PAST: AcPastMap = { 1: () => import("./data/autochess-s1.ja.json") };

export default function AutochessJa({ onShowOperator }: { onShowOperator?: (id: string) => void }) {
