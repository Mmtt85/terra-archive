...
export type AmbientAura = { kind: string; value: number; gateFaction?: string | null; gateCount?: number | null; belowThreshold?: number | null };
...
export function ambientFor(room: string, team: InfraOp[], ambient?: AmbientAura[], roomEfficiency = 0): number {
...
export function buildPlan(packageTokens: string[], roster: InfraOp[], factionSets = false, priority: ProdPriority = "gold"): Plan {
