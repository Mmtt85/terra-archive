...
const D: Record<string, Pair> = {
  ...
  "스샷 자동인식 켜짐 — 게임 화면을 캡처하고 돌아오거나, 이미지를 이 알림에 드롭하세요": ["Screenshot auto-recognition on — capture the game screen and return, or drop an image onto this toast", "スクショ自動認識オン — ゲーム画面をキャプチャして戻るか、この通知に画像をドロップしてください"],
  "클립보드 접근이 막혀 있습니다 — 이미지를 이 알림에 드롭하거나 ⌘V로 붙여넣으세요": ["Clipboard access is blocked — drop an image onto this toast or paste with ⌘V", "クリップボードへのアクセスがブロックされています — この通知に画像をドロップするか⌘Vで貼り付けてください"],
