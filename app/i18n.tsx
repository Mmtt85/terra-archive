...
const D: Record<string, Pair> = {
  ...
  "캡처가 흐릿해 인식률이 낮습니다 — 화면 공유를 껐다 다시 시작해 보세요": ["Capture looks blurry so recognition is degraded — stop and restart the screen share", "キャプチャがぼやけて認識率が低下しています — 画面共有を一度停止して再開してください"],
