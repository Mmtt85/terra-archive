...
const D: Record<string, Pair> = {
  ...
  "RIIC / 그외 · 제조 {m} · 무역 {r} · 발전 {p} — 방 카드에서 종류 변경": ["RIIC / Custom · Factory {m} · Trade {r} · Power {p} — switch types on room cards", "RIIC / カスタム · 製造{m}・貿易{r}・発電{p} — 部屋カードでタイプ変更"],
