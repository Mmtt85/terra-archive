...
const D: Record<string, Pair> = {
  ...
  "버그 수정": ["Fixed", "不具合修正"],
  "데이터 갱신": ["Data", "データ更新"],
  "지난 기록 전체보기": ["Show all past entries", "過去の履歴をすべて表示"],
  ...
  "최근 {n}일 사이의 업데이트가 없습니다 — 지난 기록 전체보기로 이전 내역을 확인하세요.": ["No updates in the last {n} days — use \u201cShow all past entries\u201d to see earlier ones.", "直近{n}日間の更新はありません — 「過去の履歴をすべて表示」で以前の内容を確認できます。"],
