...
const D: Record<string, Pair> = {
  ...
  "전송": ["Send", "送信"],
  "…무슨 이야기를 나눌까요, 박사님.": ["…What shall we talk about, Doctor?", "…何のお話をしましょうか、ドクター。"],
  "…파도가 조금 시끄럽네요. 잠시 뒤에 다시 말을 걸어 주세요.": ["…The waves are a little loud. Please talk to me again in a moment.", "…波が少し騒がしいですね。少し経ってから、また話しかけてください。"],
