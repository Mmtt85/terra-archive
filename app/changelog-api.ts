...
export type ChangeArea = "infra" | "archive" | "enemy" | "stage" | "sim" | "recruit" | "farm" | "upgrade" | "story" | "rogue" | "site";
...
export const CHANGE_AREAS: ChangeArea[] = [
  "infra", "archive", "enemy", "stage", "sim", "recruit", "farm", "upgrade", "story", "rogue", "site",
];
